...
<div class="min_booking_scroll item col-md-12">
	...
	<div class="col-md-8">
		...
		<?php  $attributes = array('name' => 'booking_online_atos','id' => 'booking_online_atos','class'=>"for_sign_up");
           echo form_open('index.php/client/setbookingDayOfficeRequestOnline/', $attributes);?>
...
$(document).ready(function(){
	...
	if (dayoffice_id == ''|| dayoffice_id == null) {
		...
		$.ajax({
		type: "POST",
		url: js_site_url+"index.php/client/getCalenderDayOffice",
	...
	$("#bookRequest").click(function(){
	 ...
	 if (purpose == "") {
		...
		$.ajax({
			type: "POST",
			url: js_site_url+"index.php/client/setbookingDayOfficeRequest",
