...
<section role="main" class="content-body">
	...
	<div class="row">
							<div class="col-lg-12">
								...
								<section class="panel">
									<header class="panel-heading">
										 ...
										 <h2 class="panel-title">EDIT Game Type</h2>
		  ...
		  <form action="<?php echo base_url();?>index.php/rooms/edit_game_types/<?php echo $row['id'];?>" method="post" enctype="multipart/form-data" name="form" id="form" class="orm-horizontal form-bordered" >
