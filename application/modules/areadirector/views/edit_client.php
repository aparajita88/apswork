...
<section role="main" class="content-body">
	...
	<div class="col-lg-12">
          ...
          echo  form_open_multipart("index.php/areadirector/edit_client/".$userinfo['userId'], $attributes);?>
	...
	<?php //print_r($userData);?>
								...
								<input class="form-control" name="last_name"   value="<?php echo $userinfo['LastName']; ?>" id="last_name" type="text"  />
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">client Email<span class="required">*</span></label>
												<div class="col-md-6">
								<input class="form-control" name="staff_email"   value="<?php echo $userinfo['userEmail']; ?>"" id="email" type="text" readonly/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">client Profile Name</label>
												<div class="col-md-6">
...
<span class="avter"><?php if($userinfo['image']!=''){?><img src="<?php echo base_url();?>assets/uploads/images/thumbnails/<?php echo $userinfo['image']; ?>" width="100" height="100" <?php }
else{?> <img src="<?php echo base_url();?>assets/front/images/no.png" width="100" height="100" <?php }?>class="preview" id="blah1"></span>
