...
<script type="text/javascript" src="<?php echo $this->config->item('base_url');?>assets/ckeditor/ckeditor.js"></script>
			<section role="main" class="content-body">
					<header class="page-header">
                        ...
                        <?php } ?>
							<div class="panel-body"><h2 class="panel-title">EDIT EXPERIENCE :   <?php echo $experience[0]['experienceName']?></h2></div>					
							<div class="panel-body panel_body_top">
							<form  name="addAttiributesspeFrm" id="addAttiributesspeFrm" method="post"
								   action="<?php echo $this->config->item('base_url');?>index.php/location/edit_experience/<?php echo $experience[0]['experienceId']?>">
							<fieldset>
                                <input type="hidden" name="experienceId" value="<?= $experience[0]['experienceId'] ?>">
								...
								<div class="form-group">
									...
									<input type="text" name="experienceName" id="experienceName"
										   class="form-control" value="<?= $experience[0]['experienceName'] ?>">
									</div>
								</div>
...
<script>
	$(document).ready(function(e){
		$("#submit").click(function(e){
			var _title = $("#experienceName").val();
		
			//alert(_desc);
			if (_title == "") {
				$("#experienceName").attr('placeholder','Please enter experience name');
