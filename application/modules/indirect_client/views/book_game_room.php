                 ...
                 <div class="col-md-12">
                    <div class="form-group sub_text" style="padding-left:15px;">
                        ...
                        <?php  $attributes = array('name' => 'bookinggame_online_atos','id' => 'bookinggame_online_atos','class'=>"for_sign_up");
                           echo form_open('index.php/indirect_client/bookingGameRequestOnline/', $attributes);?>
...
$(document).ready(function(){
    ...
    $.ajax({ 
        method: "POST", 
        url: js_site_url+"index.php/indirect_client/getGameRoom/"+game_id, 
        async: false, 
    ...
    $("#bookRequest").click(function(){
        ...
        if(gameroom_validation() && chkStartDate() && chkEndDate()){
            ...
            $.ajax({
                type: "POST",
                url: js_site_url+"index.php/indirect_client/setbookingGameRoomRequest",
...
function getgameBybusiness(value){
    $.ajax({ 
      method: "POST", 
      url: js_site_url+"index.php/indirect_client/getgameBybusiness/"+value, 
      async: true, 
      success: function(data) { 
        $("#game").html(data.trim()); 
      } 
