...
<section role="main" class="content-body">
	...
	<div class="row">
							<div class="col-lg-12">
								...
								<section class="panel">
									<header class="panel-heading">
										 ...
										 <h2 class="panel-title">EDIT CONCIERGE TYPE</h2>
											 
									 
						<?php 
										$row=$concierge_types[0];
		  ...
		  <form action="<?php echo base_url();?>index.php/rooms/edit_concierge_types/<?php echo $row['id'];?>" method="post" enctype="multipart/form-data" name="form" id="form" class="orm-horizontal form-bordered" >
