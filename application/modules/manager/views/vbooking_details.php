							...
							<div class="panel-body panel_body_top" id="pnlservicebody">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                    ...
                                    <td class="center hidden-phone">
										...
										<a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" onclick="appbookreject('<?php echo $id;?>',$('#book_type').val())" title="Reject"><font color="red"><i class="fa fa-ban" style="font-size:18px;"></i></font>
</a>
										<?php }else{?>
