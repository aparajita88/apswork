...
<!-- start: page -->
<section class="panel">
<div class="panel-body"><h2 class="panel-title">Book Meeting Room</h2></div>
<div class="panel-body panel_body_top">
	<div class="row booking_carousel_min_min">
			...
			<div class="form-group sub_text1">
			   <label for="inputDefault" class="col-md-12 control-label pad_left0">Business Centers :</label>
				<div class="col-md-12 pad_left0">
					<select  class="form-control mb-md" name="business" id="business" onchange="getmeetingBybusiness(this.value)" onclick="removeValidateHtml('business')" >
		...
		<div class="col-md-3 selection">
			<div class="form-group sub_text1">							
				<label for="inputDefault" class="col-md-12 control-label pad_left0">Meeting Rooms :</label>
				<div class="col-md-12 pad_left0">
					<select  class="form-control mb-md" name="meeting" id="meeting" onchange="getmeetingByLocation('this.value')" onclick="removeValidateHtml('locker')" >
                <?php
...
<div class="min_booking_scroll item col-md-12">
	...
	<div class="col-md-8">
		...
		<?php  $attributes = array('name' => 'booking_online_atos','id' => 'booking_online_atos','class'=>"for_sign_up");
           echo form_open('index.php/indirect_client/bookingMeetingRequestOnline/', $attributes);?>
...
$(document).ready(function(){
	...
	if (meeting_id == '' || meeting_id == null) {
		...
		$.ajax({
		type: "POST",
		url: js_site_url+"index.php/indirect_client/getCalenderMeeting",
...
$("#bookRequest").click(function(){
 ...
 if (purpose == "") {
	...
	$.ajax({
		type: "POST",
		url: js_site_url+"index.php/indirect_client/setbookingMeetingRequest",
		data: { meeting_id: meeting_id, purpose: purpose, price:price},
		dataType: "json",
		success: function(data, textStatus, jqXHR) {
...
if(meeting=='0'){
	...
	$('#meeting').addClass('redmessage');
	return false;
}else{
	$('#meeting').removeClass('redmessage');
	return true;
}			
}      
...
function getmeetingBybusiness(value){
$.ajax({ 
  method: "POST", 
  url: js_site_url+"index.php/indirect_client/getmeetingBybusiness/"+value, 
  async: true, 
  success: function(data) { 	  	
	$("#meeting").html(data.trim());      
  } 
});		
}          
</script>
