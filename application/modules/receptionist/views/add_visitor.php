		...
		<section role="main" class="content-body">
					...
					<section class="panel">
						...
						<header class="panel-heading">
							...
							<h2 class="panel-title">Add Visitor</h2>
							
						</header>
						
					<div class="panel-body">
							<form  name="addAttiributesspeFrm" id="addAttiributesspeFrm" method="post"
								   action="<?php echo $this->config->item('base_url');?>index.php/receptionist/added_visitor">
							<fieldset>
                                 <div class="form-group">
									...
									<select name="client" id="client" class="form-control">
                                        ...
                                        <?php foreach($client_list as $clntlst) {?>
											<option value="<?php echo $clntlst['userId'];?>"><?php echo $clntlst['FirstName']." ".$clntlst['LastName'];?></option>
								...
								<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-timepicker class="form-control" name="in_time" id="in_time">
													</div>
												</div>
											...
											<label class="col-md-3 control-label">Out Time</label>
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-timepicker class="form-control" name="out_time" id="out_time">
													</div>
												</div>
						                      </div>
							</fieldset>
