...
$(document).ready(function(){
	...
	if (conference_id == ''|| conference_id == null) {
		...
		$.ajax({
		type: "POST",
		url: js_site_url+"index.php/receptionist/getCalender",
	...
	$("#bookRequest").click(function(){
		...
		$.ajax({
			type: "POST",
			url: js_site_url+"index.php/receptionist/setbookingRequest",
			data: { conference_id: conference_id, purpose: purpose, price:price , userId:userId},
			dataType: "json",
			success: function(data, textStatus, jqXHR) {
				console.log("Success Msg: "+textStatus);
				if (data == true) {
