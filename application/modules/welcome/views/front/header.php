...
<div class="telefonedeal-top-bar" id="telefonedeal-top">
    ...
    <div class="row"> 
        <div class="subheader">
            <div class="pull-right"> <a href="#">About Us</a> | <a href="#">Contact Us</a> | <a href="#">Careers</a> | <a href="#">24x7 Customer Care</a> | <a target="_blank" href="<?php echo $this->config->item('base_url');?>index.php/users/admin/sellerlogin">Sell</a> | <?php if($this->session->userdata('teleFrontUserId')!=""){ ?><a href="javascript:void(0);" onclick="frontLogout()">Logout</a><?php }else{ ?> <a class="btn btn-launch" href="javascript:;" data-toggle="modal" data-target="#loginModal"><img src="<?php echo $this->config->item('base_url');?>assets/front/images/ico-signup.png" alt="Signup"> Signup</a> | <a class="btn btn-launch" href="javascript:;" data-toggle="modal" data-target="#loginModal"><img src="<?php echo $this->config->item('base_url');?>assets/front/images/ico-login.png" alt="Login"> Login</a> <?php } ?></div>
        </div>
    </div>
    </div>
</div>
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <!--container-->
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
              <form class="navbar-form navbar-left formsearch" role="search" action="<?php echo $this->config->item('base_url');?>index.php/home/searchproduct" method="post" name="searchform" id="searchform">
                <div class="form-group searchDiv">
                  <input type="search" name="prosearch" id="prosearch" class="form-control" required  placeholder="Search by Product, Category">
        ...
        <nav id="cbp-hrmenu" class="cbp-hrmenu navbar-collapse collapse">
            <ul>
				...
				?>
                        ...
                        ?>
                        <div class="menu-image"><img src="<?php echo $this->config->item('base_url');?>assets/uploads/images/medium/<?php echo $menVal['productCategoryImage']; ?>" alt=""></div>
                        </div>
                        </div>
							</li>		
	...
	<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
		<div class="modal-dialog">
	    	<div class="modal-content login-modal">
	    		<form name="loginSignUpFrm" id="loginSignUpFrm" method="post">
		      			...
		      			<div role="tabpanel" class="login-tab">
						 	...
						 	<div class="tab-content">
						    	<div role="tabpanel" class="tab-pane active text-center" id="home">
						    		&nbsp;&nbsp;
						    		<span id="login_fail" class="response_error" style="color:red; display: none;">The username and password you entered don't match.</span>
						    		<div class="clearfix"></div>
						    		
										<div class="form-group">
									    	<div class="input-group">
									      		<div class="input-group-addon"><i class="fa fa-user"></i></div>
									      		<input onfocus="checkNullProfFront()" type="text" class="form-control" id="login_email" name="login_email" placeholder="Email-Id">
									    	</div>
									  	...
									  	<div class="form-group">
									    	<div class="input-group">
									      		...
									      		<input onfocus="checkNullProfFront()" type="password" class="form-control" id="login_password" name="login_password" placeholder="Password">
									    	</div>
									    	<span class="help-block has-error" id="password-error"></span>
									  	</div>
							  			<button type="button" id="login_btn" onclick="front_login()" class="btn bt-login" data-loading-text="Signing In....">Login</button>
							  			<div class="clearfix"></div>
						    		...
						    		<div class="clearfix"></div>
									  	...
									  	<div class="form-group">
									    	<div class="input-group">
									      		...
									      		<input onfocus="checkNullProfFront()" type="text" class="form-control" id="signUpemail" name="signUpemail" placeholder="Email">
									    	</div>
									  	...
									  	<div class="form-group">
									    	<div class="input-group">
									      		<div class="input-group-addon"><i class="fa fa-lock"></i></div>
									      		<input onfocus="checkNullProfFront()" type="text" class="form-control" id="signUppassword" name="signUppassword" placeholder="Password">
									    	</div>
									  	...
									  	<div class="form-group">
									    	<div class="input-group">
									      		<div class="input-group-addon"><i class="fa fa-lock"></i></div>
									      		<input onfocus="checkNullProfFront()" type="text" class="form-control" id="signUpConfirmpassword" name="signUpConfirmpassword" placeholder="Confirm password">
									    	</div>
									    	<span class="help-block has-error" data-error='0' id="username-error"></span>
									  	</div>
							  			<button type="button" id="register_btn" onclick="frontSignup()" class="btn bt-login" data-loading-text="Registering....">Register</button>
										<div class="clearfix"></div>
										<div class="login-modal-footer">
							  				<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-6">
						    	...
						    	<div role="tabpanel" class="tab-pane text-center" id="forget_password">
						    		...
						    		<form>
										<div class="form-group">
							  			...
							  			<button type="button" id="reset_btn" class="btn bt-login" data-loading-text="Please wait....">Forget Password</button>
										<div class="clearfix"></div>
										<div class="login-modal-footer">
							  				<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-6">
