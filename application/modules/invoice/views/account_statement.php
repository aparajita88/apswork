    ...
    <div class="panel-body">
     ...
     <div class="panel-body panel_body_top">
        ...
        <div class="form-group mainform">
            <div class="col-md-6">
                          <span style="font-weight: bold; margin-right: 15px;">Centre:</span> <span><?= ucfirst($userData['l_name']); ?>, <?= ucfirst($userData['c_name']); ?></span>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                          <span style="font-weight: bold; margin-right: 15px;">Customer:</span> <span><?= ucfirst($userData['company_name']); ?></span>
            </div>
            <div class="col-md-6">
     ...
     <?php  $attributes = array('name' => 'account_stmt_frm','id' => 'account_stmt_frm','class'=>"for_sign_up");
	   echo form_open('index.php/invoice/account_statements/', $attributes);?>
