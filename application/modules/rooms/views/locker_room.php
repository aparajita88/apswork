...
<section role="main" class="content-body">
	...
	<style>
		...
		<section class="panel">
			...
			<h2 class="panel-title">Locker Rooms</h2>
			</div>
							<header class="panel-heading">
								...
								<div class="panel-actions">
									<a href="<?php echo $this->config->item('base_url');?>index.php/rooms/add_locker" class="panel-action" title="Add Locker"><i class="fa fa-plus"></i></a>
			...
			<div id="table_result_ajax" >
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
											...
											if(!empty($locker_room)){
		  	foreach($locker_room as $row)
			{
		     ?>
										<tr class="gradeX">
											...
											<td id="statusId<?php echo $row['locker_id']; ?>"  class="center hidden-phone">
												<a title="<?php if($row['status']==1){ echo 'Active'; } else{ echo 'Inactive';} ?>" class="demo-basic" href="javascript:void(0)" onclick="changeroomStatus('<?php echo $row['locker_id']; ?>','<?php echo $row['status']; ?>')">
												<?php if($row['status']==1){ echo 'Active'; } else{ echo 'Inactive';} ?>
												</a>
											</td>
											<td class="actions">
															<a href="<?php echo base_url();?>index.php/rooms/edit_locker_room/<?php echo $row['locker_id'];?>" ><i class="fa fa-pencil"></i></a>
														<!----	<a title="Add Image" style="margin-left: 4px;" class="on-default edit-row" href="<?php// echo base_url();?>index.php/vendor/add_classified_images/<?php //echo $row['classifiedId'];?>"><i class="fa fa-picture-o"></i></a>
															...
															<a href="<?php echo base_url();?>index.php/rooms/delete_locker_room/<?php echo $row['locker_id'];?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
										<?php }}else{?>											
