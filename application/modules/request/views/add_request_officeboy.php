...
<section role="main" class="content-body">
	...
	<div class="row">
			...
			<h2 class="panel-title">Request For Office Boy</h2>
			</div>
          ...
          echo  form_open_multipart('index.php/request/add_request_officeboy', $attributes); ?>
...
<script type="text/javascript">
     ...
     $(document).ready(function() {
      $("#add_classifieds").click(function(){
			...
			//alert('1');
			if(cityValidation() && locationValidation() && vendorName() &&  classifiedsAddressValidation() && clientvalidation()){
