...
$(document).ready(function(){
	...
	if (meeting_id == '' || meeting_id == null) {
		...
		$.ajax({
		type: "POST",
		url: js_site_url+"index.php/receptionist/getCalenderMeeting",
	...
	$("#bookRequest").click(function(){
		...
		$.ajax({
			type: "POST",
			url: js_site_url+"index.php/receptionist/setbookingMeetingRequest",
			data: { meeting_id: meeting_id, purpose: purpose, price:price, userId:userId},
			dataType: "json",
			success: function(data, textStatus, jqXHR) {
				console.log("Success Msg: "+textStatus);
				if (data == true) {
