...
<section role="main" class="content-body">
	...
	<div class="row">
			...
			<h2 class="panel-title">Add Game Room</h2>
			</div>
									<header class="panel-heading">
										<div class="panel-actions">
											 
										</div>
		<form action="<?php echo base_url();?>index.php/rooms/add_game" method="post" enctype="multipart/form-data" name="form" id="form" class="orm-horizontal form-bordered">								
										<?php // $attributes = array('name' => 'form','id' => 'form','class'=>"orm-horizontal form-bordered");
         //  echo  form_open_multipart('index.php/rooms/add_game', $attributes);?>
...
<div id="img"></div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 chk">
								 <?php  foreach($all_game_types as $key=>$value) {
											//echo '<option value="'.$value['cityId'].'" selected>'.$value['name'].'</option>'; 
											echo '<input class="sel" type="checkbox" name="chkbox[]" value="'.$value['id'].'">  '.$value['name'].'</input><br/>';
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input class="form-control" name="price" id="price" value=""  type="text">
							</div>
						</div>
