...
$(document).ready(function(){
	$.ajax({
	type: "GET",
	url: js_site_url+"index.php/indirect_client/getTodo",
	dataType: "html",
...
background:url(<?php echo base_url(); ?>application/modules/indirect_client/views/dot.png) no-repeat left 18px;}
