...
<section role="main" class="content-body">
	...
	<div class="row">
			...
			<h2 class="panel-title">Edit Day Office</h2>
			</div>
			<br>
									<header class="panel-heading">
										...
										$row=$day_office[0];
									?>
		  <form action="<?php echo base_url();?>index.php/rooms/edit_day_office/<?php echo $row['dayoffice_id'];?>" method="post" enctype="multipart/form-data" name="form" id="form" class="orm-horizontal form-bordered" >
