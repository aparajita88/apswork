			...
			<br>
						...
						<div id="error" style="display:none"  ></div>
								...
								<div class="panel-actions">
									<a href="<?php echo $this->config->item('base_url');?>index.php/rooms/add_meeting" class="panel-action" title="Add Meeting"><i class="fa fa-plus"></i></a>
		  	...
		  	foreach($meeting_rooms as $row)
			{
		     ?>
										<tr class="gradeX">
											...
											<td id="statusId<?php echo $row['meeting_id']; ?>"  class="center hidden-phone">
												<a title="<?php if($row['status']==1){ echo 'Active'; } else{ echo 'Inactive';} ?>" class="demo-basic" href="javascript:void(0)" onclick="changeroomStatus('<?php echo $row['meeting_id']; ?>','<?php echo $row['status']; ?>')">
												<?php if($row['status']==1){ echo 'Active'; } else{ echo 'Inactive';} ?>
												</a>
											</td>
											<td class="actions">
															<a href="<?php echo base_url();?>index.php/rooms/edit_meeting_room/<?php echo $row['meeting_id'];?>" ><i class="fa fa-pencil"></i></a>
														<!----	<a title="Add Image" style="margin-left: 4px;" class="on-default edit-row" href="<?php// echo base_url();?>index.php/vendor/add_classified_images/<?php //echo $row['classifiedId'];?>"><i class="fa fa-picture-o"></i></a>
															...
															<a href="<?php echo base_url();?>index.php/rooms/delete_meeting_room/<?php echo $row['meeting_id'];?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i></a>
														</td>
										</tr>
										<?php }}else{?>
