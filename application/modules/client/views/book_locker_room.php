                 ...
                 <div class="col-md-12">
                    <div class="form-group sub_text" style="padding-left:15px;">
						...
						<?php  $attributes = array('name' => 'bookinglocker_online_atos','id' => 'bookinglocker_online_atos','class'=>"for_sign_up");
				           echo form_open('index.php/client/bookingLockerRequestOnline/', $attributes);?>
...
$(document).ready(function(){
    ...
    $.ajax({ 
      method: "POST", 
      url: js_site_url+"index.php/client/getLockerRoom/"+locker_id, 
      async: false, 
    ...
    $("#bookRequest").click(function(){
	 	...
	 	if(CheckRadio() && chkStartDate() && chkEndDate() && chkLocNbr()){
			...
			$.ajax({
				type: "POST",
				url: js_site_url+"index.php/client/setbookingLockerRequest",
