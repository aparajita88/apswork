		...
		<div class="right-wrapper pull-right">
			...
			<!---<a class="sidebar-right-toggle" data-open="sidebar-right"><i class="fa fa-chevron-left"></i></a>--->
					...
					<section class="panel">
                        ...
                        <?php } ?>
							<div class="panel-body"><h2 class="panel-title">GAME TYPE LIST
									<a href="<?php echo $this->config->item('base_url');?>index.php/rooms/add_game_types" class="panel-action pull-right" title="Add Business Centers"><i class="fa fa-plus"></i></a></h2></div>					
								     ...
								     ?>
										<tr class="gradeX">
											...
											<td id="statusId<?php echo $row['id']; ?>"  class="center hidden-phone">
												<a title="<?php if($row['status']==1){ echo 'Active'; } else{ echo 'Inactive';} ?>" class="demo-basic" href="javascript:void(0)" onclick="changegametypeStatus('<?php echo $row['id']; ?>','<?php echo $row['status']; ?>')">
												<?php if($row['status']==1){ echo 'Active'; } else{ echo 'Inactive';} ?>
												</a>
											</td>
											<td class="actions">
															<a href="<?php echo base_url();?>index.php/rooms/edit_game_types/<?php echo $row['id'];?>" ><i class="fa fa-pencil"></i></a>													
															<a href="<?php echo base_url();?>index.php/rooms/delete_game_types/<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
									<?php
									}
											...
											<tr class="gradex"><td colspan="6">No game types  Available.....</td></tr>
...
function changegametypeStatus(id,status)
{
	//alert(id);
	//alert(js_site_url);
