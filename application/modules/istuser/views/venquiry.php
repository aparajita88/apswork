...
<section role="main" class="content-body">
  ...
  <section class="panel">
   ...
   <form class="mainform" autocomplete="off" method="POST" action="<?php echo base_url(); ?>index.php/istuser/enquiry">
            <div class="col-lg-6">
 ...
 <script>
	function ajaxSearchF() {
      ...
      if (input_data.length === 0) {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>index.php/istuser/autocompletef/",
              data: "eml="+input_data,
  ...
  function ajaxSearchL() {
      ...
      if (input_data.length === 0) {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>index.php/istuser/autocompletel/",
              data: "eml="+input_data,
              success: function(data) {
  ...
  function litxt(txt){
    ...
    var cityid;
     $.ajax
      ({ 
        url: '<?php echo base_url();?>index.php/istuser/user_display_info',
        data: "eml="+txt,
        type: 'post',
  ...
  function get_manager(val){
    $.ajax({ 
        method: "POST", 
        url: "<?php echo base_url(); ?>index.php/istuser/getManagerByCityLocation",
        data: "val="+val, 
        async: true, 
        success: function(data) { 
          $("#manager").html("");
  ...
  function get_source_detail(val){
    $.ajax({ 
        method: "POST", 
        url: "<?php echo base_url(); ?>index.php/istuser/getSourceDetail",
        data: "val="+val, 
        async: true, 
        success: function(data) { 
          $("#sourceDetail").html("");
