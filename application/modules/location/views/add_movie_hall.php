...
<script type="text/javascript" src="<?php echo $this->config->item('base_url');?>assets/ckeditor/ckeditor.js"></script>
		...
		<section role="main" class="content-body">
					...
					<section class="panel">
                        ...
                        <?php } ?>
							<div class="panel-body"><h2 class="panel-title">ADD MOVIE HALL</h2></div>					
							<div class="panel-body panel_body_top">
							<form  name="addAttiributesspeFrm" id="addAttiributesspeFrm" method="post"
								   action="<?php echo $this->config->item('base_url');?>index.php/location/add_movie_hall">
							<fieldset>
								
								<div class="form-group">
									<label class="col-md-3 control-label" for="attributeName">Hall Name *</label>
									<div class="col-md-8">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
									<textarea name="hall_location" id="hall_location"
