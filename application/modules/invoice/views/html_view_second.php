...
<table border="0" cellspacing="0" cellpadding="0" style="width:100%; margin:0px auto;  font-family: 'trebuchet_msregular'; font-size:14px;padding: 20px;">
     	<tr>
        	<td colspan="2" style="padding:15px 0;"><img src="<?php echo $logo_img; ?>" alt="" style="padding:5px;" /></td>
        </tr>
        ...
        <tr>
             <td colspan="2"  style="padding:5px; text-align:center;font-size:16px;"> <b>Center Name: Smartworks Business Center</b></td>
        </tr>
                    ...
                    <tr>
                      <td style="padding:10px 25px;">
                          ...
                          foreach ($bookings as $date => $times) {
                              ...
                              foreach ($times as $time) {
                                echo "&nbsp;&nbsp;".$time.'<br>';
                  				...
                  				break;
                          case "book_dayoffice":
                          echo "<b>Book Day Office</b><br><br>";
                          $bookings = json_decode($item['service_details']['booking_details'], true);
                          foreach ($bookings as $date => $times) {
                              echo "<b>Date : </b>".$date."<br>&nbsp;&nbsp;<b>Time Slots : </b><br>";
                              foreach ($times as $time) {
                        ...
                        foreach ($bookings as $floor_plan_id) {
                          ...
                          echo "<b>Virtual Office Book</b><br>";
                           /* $bookings = json_decode($item['service_details']['booking_detailes'], true);
                          foreach ($bookings as $floor_plan_id) {
                            $floor_plan_name = $this->invoice_model->getFloorPlanDetails($floor_plan_id);
                              echo "&nbsp;".ucfirst($floor_plan_name['description']).'<br>';
...
Cess)</strong></td>
        ...
        <!-- <tr>
        	<td colspan="2" valign="middle" align="center" style="padding:5px; text-align:center; font-size:13px; text-align:center; line-height:20px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type <br>specimen book. <br>It has survived not only five centuries</td>
         </tr>  -->      
 </table>