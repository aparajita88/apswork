...
<style>
  ...
  position: absolute;
	...
	<header class="panel-heading">
		<h2 class="panel-title">Add Multiple Image For Office</h2>
	</header>
	<div class="panel-body ">
		...
		<div class="table-responsive col-md-6">
          ...
          echo  form_open_multipart('index.php/vendor/add_classified_images/'.$this->uri->segment(3), $attributes);?>
						...
						<tr>
							...
							<td align="">
								<a onclick="return myFunction();" href="<?php echo base_url().'index.php/vendor/delete_classified_image/'.$this->uri->segment(3).'/'.$row1['id'];?>" class="remove_field on-default remove-row"><i class="fa fa-trash-o"></i></a>
							</td>
		...
		<div class="table-responsive col-md-6" id="uploddiv">
			...
			<form id="frmAddlisting" name="frmAddlisting" class="form-horizontal" action="<?php echo base_url().'index.php/vendor/add_classified_images/'.$this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" onsubmit="return image_upload();">
...
$(document).ready(function(){
		...
		$(document).on('click',"#def_chng", function(e){
			...
			$.ajax({
				type:'POST',
				 url: url+'index.php/vendor/changeimageorder', 
				data:pdata,
				success: function(data){
					//alert(data);
					window.location=url+"index.php/vendor/add_classified_images/"+classified_id;
				}
			})
