...
<div class="min_booking_scroll item col-md-12">
	...
	<div class="col-md-8">
		...
		<?php  $attributes = array('name' => 'booking_online_atos','id' => 'booking_online_atos','class'=>"for_sign_up");
           echo form_open('index.php/client/bookingMeetingRequestOnline/', $attributes);?>
...
$(document).ready(function(){
	...
	if (meeting_id == '' || meeting_id == null) {
		...
		$.ajax({
		type: "POST",
		url: js_site_url+"index.php/client/getCalenderMeeting",
...
$("#bookRequest").click(function(){
 ...
 if (purpose == "") {
	...
	$.ajax({
		type: "POST",
		url: js_site_url+"index.php/client/setbookingMeetingRequest",
...
$.ajax({ 
  method: "POST", 
  url: js_site_url+"index.php/client/getmeetingBybusiness/"+value, 
  async: true, 
  success: function(data) { 	  	
