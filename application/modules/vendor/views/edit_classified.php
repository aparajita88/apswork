...
<section role="main" class="content-body">
	...
	<div class="row">
		<div class="col-lg-12">
          ...
          echo  form_open_multipart("index.php/vendor/edit_classified/".$row['classifiedId'], $attributes);?>
		...
		<?php } ?>
											<div class="form-group">
												...
												<div class="col-md-6">
								<input class="form-control" name="classifieds_name"   value="<?php echo $row['classifiedName']; ?>"onFocus="value=''" id="classifieds_name" type="text"  disabled/>
												</div>
											</div>
...
<span class="avter"><?php if($row['s_deleted']==0){?><img src="<?php echo base_url();?>assets/uploads/images/small/<?php echo $row['imageName']; ?>" <?php }else{?> <img src="<?php echo base_url();?>assets/front/images/noimages.jpg" <?php }?>class="preview" id="blah1"></span>
<a><i class="icon-camera"></i></a><br><!---<input onchange="readURL(this,1);" type="file" name="ListeeTypeImage" id="ListeeTypeImage">--->
                                              ...
                                              <input type="hidden" id="imageid" name="imageid" value="<?php echo $row['id'];?>" > 
                                            </div>	-	
		...
		<div class="col-md-6" >
			<input class="form-control"   placeholder="Enter your address" name="address" value="<?php echo $row['address'];?>" id="autocomplete" type="text" >
		</div>
	</div>
	   ...
	   <div class="form-group">
		...
		<div class="col-md-6">
			<input class="form-control"   name="street_address" value="<?php echo $row['street_address'];?>"  id="street_number"  type="text">
		</div>
	    </div>
		...
		<div class="col-md-6">
		<input class="form-control"   name="city" value="<?php echo $row['cityId'];?>" id="locality"  type="text">	
        </div>
	     </div>
		...
		<div class="col-md-6">
		<input class="form-control"   name="state" value="<?php echo $row['state'];?>" id="administrative_area_level_1"  type="text">	
		</div>
		</div>
		...
		<div class="col-md-6">
		<input class="form-control"   name="zip" value="<?php echo $row['pincode'];?>" id="postal_code"  type="text">	
		</div>
		</div>
		...
		<div class="col-md-6">
		<input class="form-control"   name="country" value="<?php echo $row['countryId'];?>" id="country"  type="text">	
		</div>
		</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input class="form-control" name="minPrice" value="<?php echo $row['minPrice'];?>"  id="min_price" type="text">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Max Price</label>
							<div class="col-md-6">
								<input class="form-control" name="maxPrice" value="<?php echo $row['maxPrice'];?>" id="max_price" type="text">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input class="form-control" placeholder="" name="days" value="<?php echo $row['days'];?>" id="days" type="text" >
							</div>
						</div>
...
<script type="text/javascript">
      ...
      $("#add_classifieds").click(function(){
			...
			if( classifiedsNameValidation()  && classifiedsAddressValidation() ){
