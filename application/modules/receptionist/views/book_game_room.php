...
$(document).ready(function(){
    ...
    $.ajax({ 
        method: "POST", 
        url: js_site_url+"index.php/receptionist/getGameRoom/"+game_id, 
        async: false, 
    ...
    $("#bookRequest").click(function(){
        $("#messageError").html('');
        if(gameroom_validation() && chkStartDate() && chkEndDate() && chkUser()){
            ...
            $.ajax({
                type: "POST",
                url: js_site_url+"index.php/receptionist/setbookingGameRoomRequest",
                data: { game_room_id: game_room_id, game_type: game_type, start_date: start_date, end_date: end_date, price: price, userId:userId},
                dataType: "json",
                success: function(data, textStatus, jqXHR) {
                    console.log("Success Msg: "+textStatus);
                    if (data == true) {
