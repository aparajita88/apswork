				...
				<table class="table table-bordered table-striped mb-none" id="datatable-default-new">
					...
					<tbody>
						...
						<tr>
							...
							<a href="<?php echo base_url(); ?>index.php/areadirector/generate_invoice_html_view/<?php echo base64_encode(base64_encode($inv['id'])); ?>/<?php echo $this->uri->segment(3); ?>" title="View" target="_blank">View</a>
							&nbsp;&nbsp;
							<a href="<?php echo base_url(); ?>index.php/areadirector/generate_invoice_pdf/<?php echo base64_encode(base64_encode($inv['id'])); ?>/<?php echo $this->uri->segment(3); ?>" title="Print" target="_blank">Print</a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
...
<script type="text/javascript">
	...
	$(".selection2").change(function(){
		var id = $(this).val();
		url = js_site_url+"index.php/areadirector/all_bills/"+id;
