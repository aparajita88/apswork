    ...
    <div class="panel-body">
     ...
     <div class="col-md-3 selection pad_left0">
        ...
        <div class="form-group sub_text1">
           ...
           <div class="">
				 <select class="form-control" onchange="get_subcat(this.value);" name="cat" id="cat" onclick="removeValidateHtml('cat')">
        ...
        <div class="form-group sub_text1">
           ...
           <div class="">
				 <select class="form-control" id="sub" name="sub" onchange="get_analytics(this.value);" onclick="removeValidateHtml('sub')">
        ...
        <div class="form-group sub_text1">
           ...
           <div class="">
				 <select class="form-control" name="analytics" id="analytics" onclick="removeValidateHtml('analytics')">
   ...
   $(document).ready(function() {
        ...
        $('#print_pdf').click(function(){
         if(cityValidation() && locationValidation() && businessValidation() && analytics_category() && analytics_subcategory() && analytics_name()){
          ...
          $(this).attr("href", "<?php echo base_url();?>index.php/owner/search_analytics_pdf/"+city+"/"+location+"/"+business+"/"+start_date+"/"+end_date+"/"+cat+"/"+sub+"/"+analytics);
      }else{
      return false;
    }
      });
     ...
     // alert($("#city").val(););
      $.ajax({ 
      method: "POST", 
      url: "<?php echo base_url();?>index.php/owner/search_analytics", 
