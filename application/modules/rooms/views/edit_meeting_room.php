...
<section role="main" class="content-body">
	...
	<div class="row">
			...
			<h2 class="panel-title">Edit Meeting Room</h2>
			</div>
			<br>
          ...
          // echo  form_open_multipart('index.php/rooms/edit_meeting_room/'.$row['meeting_id'], $attributes);?>
		  <form action="<?php echo base_url();?>index.php/rooms/edit_meeting_room/<?php echo $row['meeting_id'];?>" method="post" enctype="multipart/form-data" name="form" id="form" class="orm-horizontal form-bordered" >
