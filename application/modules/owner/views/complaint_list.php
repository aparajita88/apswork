...
<style>
		...
		<section class="panel">
			...
			<div id="table_result_ajax" >
                           ...
                           -->
                   Total Complaints:   <label id="result"> <?php   echo $total_complaints; ?></label>  	
				        </table>
							</div>	
...
function get_result(){
	...
	//alert(location_id);
	//alert(city_id);
	if(location_id!='' || city_id!='' ){
		//alert('1')
$.ajax({ 
      method: "POST", 
      url: "<?php echo base_url();?>index.php/owner/get_result_complaints", 
      data: {location_id:location_id,city_id:city_id }, 
      async: false, 
      success: function(data) { 
	  //alert(data);	
