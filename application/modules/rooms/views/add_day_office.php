...
<section role="main" class="content-body">
	...
	<div class="row">
			...
			<h2 class="panel-title">Add Day Office</h2>
			</div>
			<br>
		...
		<form action="<?php echo base_url();?>index.php/rooms/add_day_office" method="post" enctype="multipart/form-data" name="form" id="form" class="orm-horizontal form-bordered">								
