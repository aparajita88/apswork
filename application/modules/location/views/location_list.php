<?php require_once(FCPATH.'assets/admin/lib/header_location.php'); ?> 
<?php die('1212'); ?>
		...
		<div class="right-wrapper pull-right">
			...
			<!---<a class="sidebar-right-toggle" data-open="sidebar-right"><i class="fa fa-chevron-left"></i></a>--->
					...
					<section class="panel">
                        ...
                        <?php } ?>
							<div class="panel-body"><h2 class="panel-title">LOCATION LIST
							
<a href="<?php echo $this->config->item('base_url');?>index.php/location/add_location" class="panel-action pull-right" title="Add Location"><i class="fa fa-plus"></i></a>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                   ...
                                   <td><?php echo $row['c_name']; ?></td>
											...
											<td class="center hidden-phone">
												<a title="Edit" class="demo-basic" href="<?php echo $this->config->item('base_url');?>index.php/location/edit_location/<?php echo $id;?>/<?php echo $row['cityId'];?>"><i class="fa fa-edit"></i></a>
											</td>
											<td class="center hidden-phone">
