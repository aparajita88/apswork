...
<section role="main" class="content-body">
    ...
    <section class="panel custom_boxes">
        			<div class="row">
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo count($total_clients); ?></div>
                                            <div class="big">Total Clients</div>
                                        </div>
                                    </div>
                                </div>
                               <a href="<?php echo base_url(); ?>index.php/owner/client_list">
                        ...
                        <div class="col-lg-4 col-md-3">
                            <div class="panel  panel-primary panel_green panel_red">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $total_occupancy;?></div>
                                            <div class="big">Total Occupancy</div>
                                        </div>
                                    </div>
                                </div>
                              <a href="<?php echo base_url(); ?>index.php/owner/occupancy_list">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                          ...
                          <div class="col-lg-4 col-md-3">
                            <div class="panel  panel-primary panel_green panel_orange">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <i><img alt="" src="<?php echo $this->config->item('base_url');?>application/modules/vendor/views/img/i2.png"></i>
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $total_services;?></div>
                                            <div class="big">Total Services</div>
                                        </div>
                                    </div>
                                </div>
                              <a href="<?php echo base_url(); ?>index.php/owner/service_list">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                                        <span class="pull-right fa_circle1"><i class="fa fa-angle-right fa-angle-right1 "></i></span>
                                        <div class="clearfix"></div>
                   ...
                   <div class="row">
                         <div class="col-lg-4 col-md-3">
                            <div class="panel  panel-primary panel_green">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $total_seats;?></div>
                                            <div class="big">Total Rooms</div>
                                        </div>
                                    </div>
                                </div>
                            <a href="<?php echo base_url(); ?>index.php/owner/seats_list">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                                        <span class="pull-right fa_circle1"><i class="fa fa-angle-right fa-angle-right1 "></i></span>
                                        <div class="clearfix"></div>
                            ...
                            <div class="col-lg-4 col-md-3">
                            <div class="panel  panel-primary panel_green panel_bluee">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <i><img alt="" src="<?php echo $this->config->item('base_url');?>application/modules/vendor/views/img/i2.png"></i>
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $total_complaints;?></div>
                                            <div class="big">Total Complaints</div>
                                        </div>
                                    </div>
                                </div>
                               <a href="<?php echo base_url(); ?>index.php/owner/complaint_list">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                                        <span class="pull-right fa_circle1"><i class="fa fa-angle-right fa-angle-right1 "></i></span>
                                        <div class="clearfix"></div>
    ...
    <div class="clearfix"></div>
		...
		.custom_boxes .panel_green .panel-heading {  border-color: #5cb85c !important; background-color: #5cb85c !important;}
		 ...
		 .custom_boxes .panel_orange { border:1px solid #efad4d !important;}
 		 .custom_boxes .panel_orange  .panel-heading { background:#efad4d !important; border-color: #efad4d !important;}
		 .custom_boxes .panel_orange  .fa-angle-right1 {background:#efad4d !important;}
		 
		 .custom_boxes .panel_red { border:1px solid #d9544f !important;}
 		 .custom_boxes .panel_red  .panel-heading { background:#d9544f !important; border-color: #d9544f !important;}
		  .custom_boxes .panel_red  .fa-angle-right1 {background:#d9544f !important;}
		 
		 .custom_boxes .panel_bluee { border:1px solid #496885 !important;}
 		 .custom_boxes .panel_bluee  .panel-heading { background:#496885 !important; border-color: #496885 !important;}
		  .custom_boxes .panel_bluee  .fa-angle-right1 {background:#496885 !important;}
