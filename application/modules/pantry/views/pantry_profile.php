...
<section role="main" class="content-body">
	...
	<div class="col-lg-12">
          ...
          echo  form_open_multipart("index.php/receptionist/updateProfile/".$userData['userId'], $attributes);?>
	...
	<?php //print_r($userData);?>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
								<input class="form-control" name="first_name"   value="<?php echo $userData['FirstName']; ?>" id="first_name" type="text"  />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Last Name<span class="required">*</span></label>
												<div class="col-md-6">
								<input class="form-control" name="last_name"   value="<?php echo $userData['LastName']; ?>" id="last_name" type="text"  />
												</div>
											</div>
											<div class="form-group">
...
<span class="avter"><?php if($userData['image']!=''){?><img src="<?php echo base_url();?>assets/uploads/images/thumbnails/<?php echo $userData['image']; ?>" <?php }else{?> <img src="<?php echo base_url();?>assets/front/images/NoProfileImage.png" <?php }?>class="preview" id="blah1"></span>
<a><i class="icon-camera"></i></a><br><input onchange="readURL(this,1);" type="file" name="profile_image" id="ListeeTypeImage">
