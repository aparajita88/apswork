...
$(document).ready(function(){
	...
	$.ajax({
		type: "GET",
		url: js_site_url+"index.php/receptionist/clearSessionArray",
		success: function(data, textStatus, jqXHR) {
	...
	if (dayoffice_id == ''|| dayoffice_id == null) {
		...
		$.ajax({
		type: "POST",
		url: js_site_url+"index.php/receptionist/getCalenderDayOffice",
	...
	$("#bookRequest").click(function(){
		...
		$.ajax({
			type: "POST",
			url: js_site_url+"index.php/receptionist/setbookingDayOfficeRequest",
