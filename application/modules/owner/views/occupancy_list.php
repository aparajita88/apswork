...
<style>
		...
		<section class="panel">
			...
			<h2 class="panel-title"> Occupancy</h2>
								...
								<select class="design_select" name="city" id="city"  onchange="get_location(this.value)" >
                                    ...
                                    <select  class="design_select" name="location" id="room">
			...
			<div id="table_result_ajax" >
                           ...
                           -->
                   Total Occupancy:   <label id="result"> <?php   echo $total_occupancy; ?></label>  	
				        </table>
							</div>	
...
function get_result(){
	...
	//alert(location_id);
	//alert(city_id);
	if(location_id!='' || city_id!='' || room!='' ){
		//alert('1')
$.ajax({ 
      method: "POST", 
      url: "<?php echo base_url();?>index.php/owner/get_result_occupancy", 
      data: {location_id:location_id,city_id:city_id,room:room }, 
      async: false, 
      success: function(data) { 
	 // alert(data);	
